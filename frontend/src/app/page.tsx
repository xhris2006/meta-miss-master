...
import PushPermissionGate from "@/components/push/PushPermissionGate";
      ...
      <div className="lp">
        ...
        <div className="lp-top">
          <div className="lp-brand">
            ...
            <div>
              <div className="lp-brand-name">REINES <b>DU META</b></div>
        ...
        <div style={{ margin: "18px 0 10px" }}>
          <PushPermissionGate
            title="Avant de continuer, activez les notifications"
            description="Cette étape vous permet de recevoir une alerte immédiate quand les votes sont ouverts, quand la promo des votes doubles est activée, ou quand une mise à jour importante est publiée."
          />
        </div>
